...
package org.neo4j.ogm.metadata.impl.legacy.scanner;
...
public class ClassPathScanner {
	...
	private LegacyDomainInfo processor;
	...
	public void scan(List<String> classPaths, LegacyDomainInfo processor) {

...
package org.neo4j.ogm.multidrivertest.relationships.aaa;
...
public class AAATest extends RelationshipTrait {
	...
	private static SessionFactory sessionFactory = new SessionFactory("org.neo4j.ogm.multidrivertest.relationships.aaa");

...
package org.neo4j.ogm.multidrivertest.relationships.ab2;
...
public class AB2Test {
	...
	private static SessionFactory sessionFactory = new SessionFactory("org.neo4j.ogm.multidrivertest.relationships.ab2");

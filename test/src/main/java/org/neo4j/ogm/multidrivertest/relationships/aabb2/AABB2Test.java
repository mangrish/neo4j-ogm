...
package org.neo4j.ogm.multidrivertest.relationships.aabb2;
 ...
 */
public class AABB2Test extends RelationshipTrait {

	private static SessionFactory sessionFactory = new SessionFactory("org.neo4j.ogm.multidrivertest.relationships.aabb2");

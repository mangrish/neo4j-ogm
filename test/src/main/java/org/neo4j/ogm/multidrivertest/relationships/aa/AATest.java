...
package org.neo4j.ogm.multidrivertest.relationships.aa;
...
public class AATest extends RelationshipTrait {
	...
	private static SessionFactory sessionFactory = new SessionFactory("org.neo4j.ogm.multidrivertest.relationships.aa");

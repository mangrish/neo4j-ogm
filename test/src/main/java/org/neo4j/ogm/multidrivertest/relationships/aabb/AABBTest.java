...
package org.neo4j.ogm.multidrivertest.relationships.aabb;
...
public class AABBTest extends RelationshipTrait {
	...
	private static SessionFactory sessionFactory = new SessionFactory("org.neo4j.ogm.multidrivertest.relationships.aabb");
